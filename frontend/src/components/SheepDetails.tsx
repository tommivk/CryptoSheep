...
const SheepDetails = ({ sheep, account }: Props) => {
  ...
  return (
    <div className="pb-10 grid grid-cols-1 grid-flow-row md:grid-cols-2 w-[900px] max-w-[90vw] h-fit">
      ...
      <div className="row-span-4">
        <div className="mx-auto w-[95%] max-w-[85vw] sm:w-[70%] flex flex-col gap-3 mt-5">
